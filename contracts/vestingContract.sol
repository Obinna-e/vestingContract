...
contract TokenVesting is Ownable, ReentrancyGuard{
    ...
    */
    constructor(address token_) {
        require(token_ != address(0x0)); //not at burn address 
    ...
    */
    function release(
        ...
        require(
            isBeneficiary || isOwner, "TokenVesting: only beneficiary and owner can release vested tokens"
        );
        uint256 vestedAmount = _computeReleasableAmount(vestingSchedule);
    ...
    /**
    *@dev Return the number of vesting schedules managed by this contract.
    *@return the number of vesting schedules
    */
